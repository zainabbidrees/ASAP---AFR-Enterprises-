...
export function nsnIntro(nsn, item) {
  return `National Stock Number ${nsn} covers ${item.toLowerCase()} items held and sourced by AFR Enterprises. The part numbers, approved manufacturers and MIL-STD characteristic data mapped to this NSN are listed below. Submit an RFQ against any line for pricing and availability.`;
}
